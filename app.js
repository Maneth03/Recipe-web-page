...
const fetchApi = async (query) => {
  recipes_container.innerHTML = `
  <img src="https://i.pinimg.com/originals/c4/cb/9a/c4cb9abc7c69713e7e816e6a624ce7f8.gif" class="loader_img" />`;
...
const showdata = async (resp) => {
  ...
  <img src= ${strMealThumb} />
      ...
      recipeCloseBtn.addEventListener("click", () => {
        ...
        view_recipeBtn.innerHTML = "view recipe";
        view_recipeBtn.style.backgroundColor = "#838bfa";
      });
...
const recipePopup = (meals) => {
  ...
  buttonlist.forEach((btn) => {
    ...
    btn.style.backgroundColor = "#838bfa";
  });
